...
(function() {
  ...
  define(["jquery", 'mustache', "backbone", "views/header", "views/home", "views/designs", "views/design", "views/code", "views/speak", "views/maxview", "text!templates/resumeTemplate.html"], function($, Mustache, Backbone, HeaderView, HomeView, DesignsView, DesignView, CodeView, SpeakView, MAXView, ResumeHTML) {
    var Router;
    Router = Backbone.Router.extend({
      initialize: function() {
        var headerView, maxView;
