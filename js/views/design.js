...
(function() {
  ...
  define(['backbone', 'mustache', 'collections/project', 'text!templates/designTemplate.html'], function(Backbone, Mustache, ProjectCollection, DesignTemplate) {
    var View;
    return View = Backbone.View.extend({
      ...
      render: function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push($(this.el).html(Mustache.render(DesignTemplate, model.attributes)));
        }
        return _results;
      }
    });
